...
cp $RPM_SOURCE_DIR/allegro-3.9.32.tar.gz $RPM_BUILD_ROOT/usr/local/src/allegro-3.9.32.tar.gz

%post
cd /usr/local/src
rm -rf allegro-3.9.32
gunzip -cd allegro-3.9.32.tar.gz | tar -xf -
rm -f allegro-3.9.32.tar.gz
cd allegro-3.9.32
...
%preun
cd /usr/local/src
make -C allegro-3.9.32 uninstall
rm -rf allegro-3.9.32
touch allegro-3.9.32.tar.gz

%files
/usr/local/src/allegro-3.9.32.tar.gz
