...
Source:         allegro-3.9.33-enduser.tar.gz
...
cp $RPM_SOURCE_DIR/allegro-3.9.33-enduser.tar.gz $RPM_BUILD_ROOT/usr/local/src/allegro-3.9.33-enduser.tar.gz

%post
cd /usr/local/src
rm -rf allegro-3.9.33
gunzip -cd allegro-3.9.33-enduser.tar.gz | tar -xf -
rm -f allegro-3.9.33-enduser.tar.gz
cd allegro-3.9.33
...
cd /usr/local/src
touch allegro-3.9.33-enduser.tar.gz

%files
/usr/local/src/allegro-3.9.33-enduser.tar.gz
