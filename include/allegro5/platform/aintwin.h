...
typedef bool (*A5O_DISPLAY_WIN_CALLBACK_PROC)
   (A5O_DISPLAY *, UINT, WPARAM, LPARAM, LRESULT*, void *);

typedef struct A5O_DISPLAY_WIN_CALLBACK A5O_DISPLAY_WIN_CALLBACK;

struct A5O_DISPLAY_WIN_CALLBACK
{
   A5O_DISPLAY_WIN_CALLBACK_PROC proc;
   void *userdata;
};

/* the extended display struct for Windows */

typedef struct A5O_DISPLAY_WIN A5O_DISPLAY_WIN;

struct A5O_DISPLAY_WIN
{
   A5O_DISPLAY display;
...
void _al_win_mouse_handle_button(int button, bool down, int x, int y, bool abs, A5O_DISPLAY_WIN *win_disp);
void _al_win_mouse_handle_leave(A5O_DISPLAY_WIN *win_display);
void _al_win_mouse_handle_enter(A5O_DISPLAY_WIN *win_display);

/* joystick routines */
void _al_win_joystick_dinput_unacquire(void *unused);
void _al_win_joystick_dinput_grab(void *A5O_DISPLAY_WIN);
...
/* icon helpers */
void  _al_win_set_display_icons(A5O_DISPLAY *display, int num_icons, A5O_BITMAP *bitmap[]);
HICON _al_win_create_icon(HWND wnd, A5O_BITMAP *sprite, int xfocus, int yfocus, bool is_cursor, bool resize);
...
bool _al_win_set_window_constraints(A5O_DISPLAY *display, int min_w, int min_h, int max_w, int max_h);
bool _al_win_get_window_constraints(A5O_DISPLAY *display, int *min_w, int *min_h, int *max_w, int *max_h);
void _al_win_apply_window_constraints(A5O_DISPLAY *display, bool onoff);
void _al_win_set_window_frameless(A5O_DISPLAY *display, HWND window, bool frameless);
...
/* cursor routines */
typedef struct A5O_MOUSE_CURSOR_WIN A5O_MOUSE_CURSOR_WIN;
struct A5O_MOUSE_CURSOR_WIN
{
   HCURSOR hcursor;
};

A5O_MOUSE_CURSOR* _al_win_create_mouse_cursor(A5O_BITMAP *sprite, int xfocus, int yfocus);
void _al_win_destroy_mouse_cursor(A5O_MOUSE_CURSOR *cursor);
bool _al_win_set_mouse_cursor(A5O_DISPLAY *display, A5O_MOUSE_CURSOR *cursor);
bool _al_win_set_system_mouse_cursor(A5O_DISPLAY *display, A5O_SYSTEM_MOUSE_CURSOR cursor_id);
