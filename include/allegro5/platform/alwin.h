 ...
 */
   ...
   #if defined _MSC_VER && !defined A5O_LIB_BUILD
...
AL_VAR(struct A5O_JOYSTICK_DRIVER, _al_joydrv_directx);
...
AL_VAR(struct A5O_JOYSTICK_DRIVER, _al_joydrv_xinput);
...
AL_VAR(struct A5O_HAPTIC_DRIVER, _al_hapdrv_directx);
...
AL_VAR(struct A5O_HAPTIC_DRIVER, _al_hapdrv_xinput);
...
AL_VAR(struct A5O_HAPTIC_DRIVER, _al_hapdrv_windows_all);
