...
struct ALLEGRO_FS_INTERFACE {
   ...
   AL_METHOD(bool,            fs_opendir,          (ALLEGRO_FS_ENTRY *e));
   AL_METHOD(ALLEGRO_FS_ENTRY *, fs_readdir,       (ALLEGRO_FS_ENTRY *e));
   AL_METHOD(bool,            fs_closedir,         (ALLEGRO_FS_ENTRY *e));

   AL_METHOD(bool,            fs_filename_exists,  (const char *path));
   AL_METHOD(bool,            fs_remove_filename,  (const char *path));
   AL_METHOD(ALLEGRO_PATH *,  fs_getcwd,           (void));
   AL_METHOD(bool,            fs_chdir,            (const char *path));
   AL_METHOD(bool,            fs_mkdir,            (const char *path));
};
...
AL_FUNC(bool,           al_fs_entry_is_dir,        (ALLEGRO_FS_ENTRY *e));
AL_FUNC(bool,           al_fs_entry_is_file,       (ALLEGRO_FS_ENTRY *e));
AL_FUNC(bool,           al_remove_fs_entry,        (ALLEGRO_FS_ENTRY *e));

AL_FUNC(bool,           al_opendir,                (ALLEGRO_FS_ENTRY *e));
AL_FUNC(ALLEGRO_FS_ENTRY *, al_readdir,            (ALLEGRO_FS_ENTRY *e));
AL_FUNC(bool,           al_closedir,               (ALLEGRO_FS_ENTRY *e));
...
AL_FUNC(bool,           al_mkdir,                  (const char *path));
