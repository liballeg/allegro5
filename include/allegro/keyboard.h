...
enum {
   ...
   __allegro_KEY_MODIFIERS    = 103,

   __allegro_KEY_LSHIFT       = 103,
   __allegro_KEY_RSHIFT       = 104,
   __allegro_KEY_LCONTROL     = 105,
   __allegro_KEY_RCONTROL     = 106,
   __allegro_KEY_ALT          = 107,
   __allegro_KEY_ALTGR        = 108,
   __allegro_KEY_LWIN         = 109,
   __allegro_KEY_RWIN         = 110,
   __allegro_KEY_MENU         = 111,
   __allegro_KEY_SCRLOCK      = 112,
   __allegro_KEY_NUMLOCK      = 113,
   __allegro_KEY_CAPSLOCK     = 114,

   __allegro_KEY_MAX          = 115
};
