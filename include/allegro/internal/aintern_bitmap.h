...
{
   int id;
   void (*blit)(int flag, AL_BITMAP *src, AL_BITMAP *dest,
   	float dx, float dy);
   void (*blit_region)(int flag, AL_BITMAP *src, float sx, float sy,
   ...
   void (*rotate_bitmap)(int flag, AL_BITMAP *source,
	float source_center_x, float source_center_y,
	AL_BITMAP *dest, float dest_x, float dest_y,
	float angle);
   void (*rotate_scaled)(int flag, AL_BITMAP *source,
	float source_center_x, float source_center_y,
	AL_BITMAP *dest, float dest_x, float dest_y,
...
//   void (*draw_bitmap)(int flag, AL_BITMAP *bitmap, float x, float y);
