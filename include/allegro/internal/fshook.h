...
struct AL_FS_HOOK_VTABLE {
   ...
   AL_METHOD(void,      fname,  (AL_FILE *fh, char *name, uint32_t len) );
   ...
   AL_METHOD(size_t,   get_file_exists,  (AL_FILE *) );
   AL_METHOD(size_t,   get_dir_exists,   (AL_FILE *) );

   AL_METHOD(size_t,   file_exists,
