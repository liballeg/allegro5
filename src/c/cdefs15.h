...
#define PUT_RGB(p,r,g,b)       bmp_write15((unsigned long) (p), makecol15((r), (g), (b)))
...
#define FUNC_POLY_SCANLINE_FLAT             _poly_scanline_flat15
#define FUNC_POLY_SCANLINE_GCOL             _poly_scanline_gcol15
