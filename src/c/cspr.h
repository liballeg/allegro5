 ...
 */
void FUNC_LINEAR_DRAW_SPRITE_V_FLIP_EX(BITMAP *dst, BITMAP *src,
                                       int dx, int dy, int mode)
{
   int x, y, w, h;
   int dxbeg, dybeg;
   int sxbeg, sybeg;
 ...
 *  Draws a sprite to a linear bitmap, flipping horizontally.
 */
void FUNC_LINEAR_DRAW_SPRITE_H_FLIP_EX(BITMAP *dst, BITMAP *src,
                                       int dx, int dy, int mode)
{
 ...
 *  Draws a sprite to a linear bitmap, flipping both vertically and
 *  horizontally.
 */
void FUNC_LINEAR_DRAW_SPRITE_VH_FLIP_EX(BITMAP *dst, BITMAP *src,
                                        int dx, int dy, int mode)
{
   int x, y, w, h;
   int dxbeg, dybeg;
