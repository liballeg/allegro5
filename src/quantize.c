 ...
 */
int generate_optimized_palette_ex(BITMAP *image, PALETTE pal, signed char rsvdcols[256], int bitsperrgb, int fraction, int maxswaps, int mindiff)
{
...
int generate_optimized_palette(BITMAP *image, PALETTE pal, signed char rsvdcols[256])
{
