...
static A5O_DISPLAY *gp2xwiz_create_display_fb(int w, int h)
{
   (void)w;
   (void)h;
   ...
   A5O_DISPLAY_GP2XWIZ_FB *d = al_calloc(1, sizeof *d);
...
static void gp2xwiz_destroy_display_fb(A5O_DISPLAY *d)
{
   A5O_SYSTEM_GP2XWIZ *s = (void *)al_get_system_driver();
   A5O_DISPLAY_GP2XWIZ_FB *wiz_disp = (void *)d;
...
static bool gp2xwiz_set_current_display_fb(A5O_DISPLAY *d)
{
   (void)d;
   return true;
}
...
static void gp2xwiz_flip_display_fb(A5O_DISPLAY *d)
{
   (void)d;
}

static void gp2xwiz_update_display_region_fb(A5O_DISPLAY *d, int x, int y,
   int w, int h)
{
   (void)x;
   (void)y;
...
static bool gp2xwiz_acknowledge_resize_fb(A5O_DISPLAY *d)
{
   (void)d;
   return false;
}
...
static bool gp2xwiz_resize_display_fb(A5O_DISPLAY *d, int w, int h)
{
   (void)d;
   (void)w;
   (void)h;
...
static bool gp2xwiz_is_compatible_bitmap_fb(A5O_DISPLAY *display,
   A5O_BITMAP *bitmap)
{
   (void)display;
   (void)bitmap;
...
static void gp2xwiz_get_window_position_fb(A5O_DISPLAY *display, int *x, int *y)
{
   (void)display;
   *x = 0;
   *y = 0;
...
static bool gp2xwiz_wait_for_vsync_fb(A5O_DISPLAY *display)
{
   (void)display;
   return false;
}
...
static A5O_BITMAP *gp2xwiz_get_backbuffer_fb(A5O_DISPLAY *display)
{
   A5O_DISPLAY_GP2XWIZ_FB *d = (void *)display;
   return d->backbuffer;
}
