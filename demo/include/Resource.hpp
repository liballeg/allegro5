...
const int RES_TITLE_MUSIC = RES_SAMPLE_START+0;
const int RES_GAME_MUSIC = RES_SAMPLE_START+1;
const int RES_BIGEXPLOSION = RES_SAMPLE_START+2;
const int RES_COLLISION = RES_SAMPLE_START+3;
const int RES_FIRELARGE = RES_SAMPLE_START+4;
const int RES_FIRESMALL = RES_SAMPLE_START+5;
const int RES_SMALLEXPLOSION = RES_SAMPLE_START+6;
const int RES_POWERUP = RES_SAMPLE_START+7;
