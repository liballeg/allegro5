...
int main(void)
{
...

   {
      ...
      METHOD methods[] =
      {
         ...
         {GETX(0), GETY(1), 0, 0, "STREAM", false, ALLEGRO_BUFFER_STREAM | ALLEGRO_BUFFER_DRAW, 0},
         {GETX(1), GETY(1), 0, 0, "STATIC", false, ALLEGRO_BUFFER_STATIC | ALLEGRO_BUFFER_DRAW, 0},
         {GETX(2), GETY(1), 0, 0, "DYNAMIC", false, ALLEGRO_BUFFER_STREAM | ALLEGRO_BUFFER_DRAW, 0},
         {GETX(0), GETY(2), 0, 0, "STREAM", true, ALLEGRO_BUFFER_STREAM | ALLEGRO_BUFFER_DRAW, 0},
         {GETX(1), GETY(2), 0, 0, "STATIC", true, ALLEGRO_BUFFER_STATIC | ALLEGRO_BUFFER_DRAW, 0},
         {GETX(2), GETY(2), 0, 0, "DYNAMIC", true, ALLEGRO_BUFFER_DYNAMIC | ALLEGRO_BUFFER_DRAW, 0}
      };
