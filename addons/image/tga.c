 ...
 */
ALLEGRO_BITMAP *al_load_tga_stream(ALLEGRO_FILE *f)
{
 ...
 */
bool al_save_tga_stream(ALLEGRO_FILE *f, ALLEGRO_BITMAP *bmp)
{
   int x, y;
   int w, h;
   ALLEGRO_LOCKED_REGION *lr;
