   ...
   switch (type) {
      case ALLEGRO_PRIM_LINE_LIST: {
         if (use_cache) {
            ...
            for (ii = 0; ii < num_vtx - 1; ii += 2) {
               _al_line_2d(texture, vbuff, &vertex_cache[ii], &vertex_cache[ii + 1]);
            }
         } else {
            int ii;
            for (ii = start; ii < end - 1; ii += 2) {
               ...
               _al_line_2d(texture, vbuff, &v1, &v2);
            }
         }
      ...
      case ALLEGRO_PRIM_LINE_STRIP: {
         if (use_cache) {
            ...
            for (ii = 1; ii < num_vtx; ii++) {
               _al_line_2d(texture, vbuff, &vertex_cache[ii - 1], &vertex_cache[ii]);
            }
         } else {
            int ii;
            int idx = 1;
            ...
            for (ii = start + 1; ii < end; ii++) {
               ...
               _al_line_2d(texture, vbuff, &vtx[0], &vtx[1]);
               idx = 1 - idx;
            }
         }
      ...
      case ALLEGRO_PRIM_LINE_LOOP: {
         if (use_cache) {
            ...
            _al_line_2d(texture, vbuff, &vertex_cache[0], &vertex_cache[num_vtx - 1]);
         } else {
            int ii;
            int idx = 1;
            ALLEGRO_VERTEX vtx[2];
      ...
      case ALLEGRO_PRIM_TRIANGLE_LIST: {
         if (use_cache) {
            ...
            for (ii = 0; ii < num_vtx - 2; ii += 3) {
               _al_triangle_2d(texture, vbuff, &vertex_cache[ii], &vertex_cache[ii + 1], &vertex_cache[ii + 2]);
            }
         } else {
            int ii;
            for (ii = start; ii < end - 2; ii += 3) {
               ...
               _al_triangle_2d(texture, vbuff, &v1, &v2, &v3);
            }
         }
      ...
      case ALLEGRO_PRIM_TRIANGLE_STRIP: {
         if (use_cache) {
            ...
            for (ii = 2; ii < num_vtx; ii++) {
               _al_triangle_2d(texture, vbuff, &vertex_cache[ii - 2], &vertex_cache[ii - 1], &vertex_cache[ii]);
            }
         } else {
            int ii;
            int idx = 2;
            ...
            for (ii = start + 2; ii < end; ii++) {
               ...
               _al_triangle_2d(texture, vbuff, &vtx[0], &vtx[1], &vtx[2]);
               idx = (idx + 1) % 3;
            }
         }
         num_primitives = num_vtx - 2;
      ...
      case ALLEGRO_PRIM_TRIANGLE_FAN: {
         if (use_cache) {
            int ii;
            for (ii = 1; ii < num_vtx; ii++) {
               _al_triangle_2d(texture, vbuff, &vertex_cache[0], &vertex_cache[ii], &vertex_cache[ii - 1]);
            }
         } else {
            int ii;
            ALLEGRO_VERTEX v0;
            ...
            for (ii = start + 1; ii < end; ii++) {
               SET_VERTEX(vtx[idx], ii)
               _al_triangle_2d(texture, vbuff, &v0, &vtx[0], &vtx[1]);
               idx = 1 - idx;
            }
         }
         num_primitives = num_vtx - 2;
      ...
      case ALLEGRO_PRIM_LINE_LIST: {
         if (use_cache) {
            ...
            for (ii = 0; ii < num_vtx - 1; ii += 2) {
               ...
               _al_line_2d(texture, vbuff, &vertex_cache[idx1], &vertex_cache[idx2]);
            }
         } else {
            int ii;
            for (ii = 0; ii < num_vtx - 1; ii += 2) {
      ...
      case ALLEGRO_PRIM_TRIANGLE_LIST: {
         if (use_cache) {
            ...
            for (ii = 0; ii < num_vtx - 2; ii += 3) {
               ...
               _al_triangle_2d(texture, vbuff, &vertex_cache[idx1], &vertex_cache[idx2], &vertex_cache[idx3]);
            }
         } else {
            int ii;
            for (ii = 0; ii < num_vtx - 2; ii += 3) {
      ...
      case ALLEGRO_PRIM_TRIANGLE_FAN: {
         if (use_cache) {
            ...
            for (ii = 1; ii < num_vtx; ii++) {
               int idx1 = indices[ii];
               int idx2 = indices[ii - 1];
               _al_triangle_2d(texture, vbuff, &vertex_cache[idx0], &vertex_cache[idx1], &vertex_cache[idx2]);
            }
         } else {
            int ii;
            ALLEGRO_VERTEX v0;
