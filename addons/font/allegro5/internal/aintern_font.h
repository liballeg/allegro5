...
struct ALLEGRO_FONT_VTABLE
{
   ...
   ALLEGRO_FONT_METHOD(int, render_char_scaled, (const ALLEGRO_FONT *f, ALLEGRO_COLOR color, int ch, float x, float y, float sw, float sh));
   ALLEGRO_FONT_METHOD(int, render, (const ALLEGRO_FONT *f, ALLEGRO_COLOR color, const ALLEGRO_USTR *text, float x, float y));
   ALLEGRO_FONT_METHOD(int, render_scaled, (const ALLEGRO_FONT *f, ALLEGRO_COLOR color, const ALLEGRO_USTR *text, float x, float y, float sw, float sh));
