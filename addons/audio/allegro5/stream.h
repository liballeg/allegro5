...
AL_FUNC(ALLEGRO_STREAM*,al_stream_create,(unsigned long frequency, enum ALLEGRO_AUDIO_ENUM depth, enum ALLEGRO_AUDIO_ENUM chan_conf, bool (*stream_update)(ALLEGRO_STREAM* stream, void* data, unsigned long samples),void (*stream_close)(ALLEGRO_STREAM*)));
