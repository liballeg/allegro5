...
AGL_API(void, glBeginConditionalRenderNV, (GLuint, GLenum))
AGL_API(void, glEndConditionalRenderNV, (void))
#endif

#if defined AGL_EXT_direct_state_access
AGL_API(void, glClientAttribDefaultEXT, (GLbitfield))
AGL_API(void, glPushClientAttribDefaultEXT, (GLbitfield))
AGL_API(void, glMatrixLoadfEXT, (GLenum, const GLfloat *))
AGL_API(void, glMatrixLoaddEXT, (GLenum, const GLdouble *))
AGL_API(void, glMatrixMultfEXT, (GLenum, const GLfloat *))
AGL_API(void, glMatrixMultdEXT, (GLenum, const GLdouble *))
AGL_API(void, glMatrixLoadIdentityEXT, (GLenum))
AGL_API(void, glMatrixRotatefEXT, (GLenum, GLfloat, GLfloat, GLfloat, GLfloat))
AGL_API(void, glMatrixRotatedEXT, (GLenum, GLdouble, GLdouble, GLdouble, GLdouble))
AGL_API(void, glMatrixScalefEXT, (GLenum, GLfloat, GLfloat, GLfloat))
AGL_API(void, glMatrixScaledEXT, (GLenum, GLdouble, GLdouble, GLdouble))
AGL_API(void, glMatrixTranslatefEXT, (GLenum, GLfloat, GLfloat, GLfloat))
AGL_API(void, glMatrixTranslatedEXT, (GLenum, GLdouble, GLdouble, GLdouble))
AGL_API(void, glMatrixFrustumEXT, (GLenum, GLdouble, GLdouble, GLdouble, GLdouble, GLdouble, GLdouble))
AGL_API(void, glMatrixOrthoEXT, (GLenum, GLdouble, GLdouble, GLdouble, GLdouble, GLdouble, GLdouble))
AGL_API(void, glMatrixPopEXT, (GLenum))
AGL_API(void, glMatrixPushEXT, (GLenum))
AGL_API(void, glMatrixLoadTransposefEXT, (GLenum, const GLfloat *))
AGL_API(void, glMatrixLoadTransposedEXT, (GLenum, const GLdouble *))
AGL_API(void, glMatrixMultTransposefEXT, (GLenum, const GLfloat *))
AGL_API(void, glMatrixMultTransposedEXT, (GLenum, const GLdouble *))
AGL_API(void, glTextureParameterfEXT, (GLuint, GLenum, GLenum, GLfloat))
AGL_API(void, glTextureParameterfvEXT, (GLuint, GLenum, GLenum, const GLfloat *))
AGL_API(void, glTextureParameteriEXT, (GLuint, GLenum, GLenum, GLint))
AGL_API(void, glTextureParameterivEXT, (GLuint, GLenum, GLenum, const GLint *))
AGL_API(void, glTextureImage1DEXT, (GLuint, GLenum, GLint, GLenum, GLsizei, GLint, GLenum, GLenum, const GLvoid *))
AGL_API(void, glTextureImage2DEXT, (GLuint, GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid *))
AGL_API(void, glTextureSubImage1DEXT, (GLuint, GLenum, GLint, GLint, GLsizei, GLenum, GLenum, const GLvoid *))
AGL_API(void, glTextureSubImage2DEXT, (GLuint, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, const GLvoid *))
AGL_API(void, glCopyTextureImage1DEXT, (GLuint, GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLint))
AGL_API(void, glCopyTextureImage2DEXT, (GLuint, GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint))
AGL_API(void, glCopyTextureSubImage1DEXT, (GLuint, GLenum, GLint, GLint, GLint, GLint, GLsizei))
AGL_API(void, glCopyTextureSubImage2DEXT, (GLuint, GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei))
AGL_API(void, glGetTextureImageEXT, (GLuint, GLenum, GLint, GLenum, GLenum, GLvoid *))
AGL_API(void, glGetTextureParameterfvEXT, (GLuint, GLenum, GLenum, GLfloat *))
AGL_API(void, glGetTextureParameterivEXT, (GLuint, GLenum, GLenum, GLint *))
AGL_API(void, glGetTextureLevelParameterfvEXT, (GLuint, GLenum, GLint, GLenum, GLfloat *))
AGL_API(void, glGetTextureLevelParameterivEXT, (GLuint, GLenum, GLint, GLenum, GLint *))
AGL_API(void, glTextureImage3DEXT, (GLuint, GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid *))
AGL_API(void, glTextureSubImage3DEXT, (GLuint, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const GLvoid *))
AGL_API(void, glCopyTextureSubImage3DEXT, (GLuint, GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei))
AGL_API(void, glMultiTexParameterfEXT, (GLenum, GLenum, GLenum, GLfloat))
AGL_API(void, glMultiTexParameterfvEXT, (GLenum, GLenum, GLenum, const GLfloat *))
AGL_API(void, glMultiTexParameteriEXT, (GLenum, GLenum, GLenum, GLint))
AGL_API(void, glMultiTexParameterivEXT, (GLenum, GLenum, GLenum, const GLint *))
AGL_API(void, glMultiTexImage1DEXT, (GLenum, GLenum, GLint, GLenum, GLsizei, GLint, GLenum, GLenum, const GLvoid *))
AGL_API(void, glMultiTexImage2DEXT, (GLenum, GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid *))
AGL_API(void, glMultiTexSubImage1DEXT, (GLenum, GLenum, GLint, GLint, GLsizei, GLenum, GLenum, const GLvoid *))
AGL_API(void, glMultiTexSubImage2DEXT, (GLenum, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, const GLvoid *))
AGL_API(void, glCopyMultiTexImage1DEXT, (GLenum, GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLint))
AGL_API(void, glCopyMultiTexImage2DEXT, (GLenum, GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint))
AGL_API(void, glCopyMultiTexSubImage1DEXT, (GLenum, GLenum, GLint, GLint, GLint, GLint, GLsizei))
AGL_API(void, glCopyMultiTexSubImage2DEXT, (GLenum, GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei))
AGL_API(void, glGetMultiTexImageEXT, (GLenum, GLenum, GLint, GLenum, GLenum, GLvoid *))
AGL_API(void, glGetMultiTexParameterfvEXT, (GLenum, GLenum, GLenum, GLfloat *))
AGL_API(void, glGetMultiTexParameterivEXT, (GLenum, GLenum, GLenum, GLint *))
AGL_API(void, glGetMultiTexLevelParameterfvEXT, (GLenum, GLenum, GLint, GLenum, GLfloat *))
AGL_API(void, glGetMultiTexLevelParameterivEXT, (GLenum, GLenum, GLint, GLenum, GLint *))
AGL_API(void, glMultiTexImage3DEXT, (GLenum, GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid *))
AGL_API(void, glMultiTexSubImage3DEXT, (GLenum, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const GLvoid *))
AGL_API(void, glCopyMultiTexSubImage3DEXT, (GLenum, GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei))
AGL_API(void, glBindMultiTextureEXT, (GLenum, GLenum, GLuint))
AGL_API(void, glEnableClientStateIndexedEXT, (GLenum, GLuint))
AGL_API(void, glDisableClientStateIndexedEXT, (GLenum, GLuint))
AGL_API(void, glMultiTexCoordPointerEXT, (GLenum, GLint, GLenum, GLsizei, const GLvoid *))
AGL_API(void, glMultiTexEnvfEXT, (GLenum, GLenum, GLenum, GLfloat))
AGL_API(void, glMultiTexEnvfvEXT, (GLenum, GLenum, GLenum, const GLfloat *))
AGL_API(void, glMultiTexEnviEXT, (GLenum, GLenum, GLenum, GLint))
AGL_API(void, glMultiTexEnvivEXT, (GLenum, GLenum, GLenum, const GLint *))
AGL_API(void, glMultiTexGendEXT, (GLenum, GLenum, GLenum, GLdouble))
AGL_API(void, glMultiTexGendvEXT, (GLenum, GLenum, GLenum, const GLdouble *))
AGL_API(void, glMultiTexGenfEXT, (GLenum, GLenum, GLenum, GLfloat))
AGL_API(void, glMultiTexGenfvEXT, (GLenum, GLenum, GLenum, const GLfloat *))
AGL_API(void, glMultiTexGeniEXT, (GLenum, GLenum, GLenum, GLint))
AGL_API(void, glMultiTexGenivEXT, (GLenum, GLenum, GLenum, const GLint *))
AGL_API(void, glGetMultiTexEnvfvEXT, (GLenum, GLenum, GLenum, GLfloat *))
AGL_API(void, glGetMultiTexEnvivEXT, (GLenum, GLenum, GLenum, GLint *))
AGL_API(void, glGetMultiTexGendvEXT, (GLenum, GLenum, GLenum, GLdouble *))
AGL_API(void, glGetMultiTexGenfvEXT, (GLenum, GLenum, GLenum, GLfloat *))
AGL_API(void, glGetMultiTexGenivEXT, (GLenum, GLenum, GLenum, GLint *))
AGL_API(void, glGetFloatIndexedvEXT, (GLenum, GLuint, GLfloat *))
AGL_API(void, glGetDoubleIndexedvEXT, (GLenum, GLuint, GLdouble *))
AGL_API(void, glGetPointerIndexedvEXT, (GLenum, GLuint, GLvoid* *))
AGL_API(void, glCompressedTextureImage3DEXT, (GLuint, GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *))
AGL_API(void, glCompressedTextureImage2DEXT, (GLuint, GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *))
AGL_API(void, glCompressedTextureImage1DEXT, (GLuint, GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, const GLvoid *))
AGL_API(void, glCompressedTextureSubImage3DEXT, (GLuint, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid *))
AGL_API(void, glCompressedTextureSubImage2DEXT, (GLuint, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid *))
AGL_API(void, glCompressedTextureSubImage1DEXT, (GLuint, GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, const GLvoid *))
AGL_API(void, glGetCompressedTextureImageEXT, (GLuint, GLenum, GLint, GLvoid *))
AGL_API(void, glCompressedMultiTexImage3DEXT, (GLenum, GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *))
AGL_API(void, glCompressedMultiTexImage2DEXT, (GLenum, GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *))
AGL_API(void, glCompressedMultiTexImage1DEXT, (GLenum, GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, const GLvoid *))
AGL_API(void, glCompressedMultiTexSubImage3DEXT, (GLenum, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid *))
AGL_API(void, glCompressedMultiTexSubImage2DEXT, (GLenum, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid *))
AGL_API(void, glCompressedMultiTexSubImage1DEXT, (GLenum, GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, const GLvoid *))
AGL_API(void, glGetCompressedMultiTexImageEXT, (GLenum, GLenum, GLint, GLvoid *))
AGL_API(void, glNamedProgramStringEXT, (GLuint, GLenum, GLenum, GLsizei, const GLvoid *))
AGL_API(void, glNamedProgramLocalParameter4dEXT, (GLuint, GLenum, GLuint, GLdouble, GLdouble, GLdouble, GLdouble))
AGL_API(void, glNamedProgramLocalParameter4dvEXT, (GLuint, GLenum, GLuint, const GLdouble *))
AGL_API(void, glNamedProgramLocalParameter4fEXT, (GLuint, GLenum, GLuint, GLfloat, GLfloat, GLfloat, GLfloat))
AGL_API(void, glNamedProgramLocalParameter4fvEXT, (GLuint, GLenum, GLuint, const GLfloat *))
AGL_API(void, glGetNamedProgramLocalParameterdvEXT, (GLuint, GLenum, GLuint, GLdouble *))
AGL_API(void, glGetNamedProgramLocalParameterfvEXT, (GLuint, GLenum, GLuint, GLfloat *))
AGL_API(void, glGetNamedProgramivEXT, (GLuint, GLenum, GLenum, GLint *))
AGL_API(void, glGetNamedProgramStringEXT, (GLuint, GLenum, GLenum, GLvoid *))
AGL_API(void, glNamedProgramLocalParameters4fvEXT, (GLuint, GLenum, GLuint, GLsizei, const GLfloat *))
AGL_API(void, glNamedProgramLocalParameterI4iEXT, (GLuint, GLenum, GLuint, GLint, GLint, GLint, GLint))
AGL_API(void, glNamedProgramLocalParameterI4ivEXT, (GLuint, GLenum, GLuint, const GLint *))
AGL_API(void, glNamedProgramLocalParametersI4ivEXT, (GLuint, GLenum, GLuint, GLsizei, const GLint *))
AGL_API(void, glNamedProgramLocalParameterI4uiEXT, (GLuint, GLenum, GLuint, GLuint, GLuint, GLuint, GLuint))
AGL_API(void, glNamedProgramLocalParameterI4uivEXT, (GLuint, GLenum, GLuint, const GLuint *))
AGL_API(void, glNamedProgramLocalParametersI4uivEXT, (GLuint, GLenum, GLuint, GLsizei, const GLuint *))
AGL_API(void, glGetNamedProgramLocalParameterIivEXT, (GLuint, GLenum, GLuint, GLint *))
AGL_API(void, glGetNamedProgramLocalParameterIuivEXT, (GLuint, GLenum, GLuint, GLuint *))
AGL_API(void, glTextureParameterIivEXT, (GLuint, GLenum, GLenum, const GLint *))
AGL_API(void, glTextureParameterIuivEXT, (GLuint, GLenum, GLenum, const GLuint *))
AGL_API(void, glGetTextureParameterIivEXT, (GLuint, GLenum, GLenum, GLint *))
AGL_API(void, glGetTextureParameterIuivEXT, (GLuint, GLenum, GLenum, GLuint *))
AGL_API(void, glMultiTexParameterIivEXT, (GLenum, GLenum, GLenum, const GLint *))
AGL_API(void, glMultiTexParameterIuivEXT, (GLenum, GLenum, GLenum, const GLuint *))
AGL_API(void, glGetMultiTexParameterIivEXT, (GLenum, GLenum, GLenum, GLint *))
AGL_API(void, glGetMultiTexParameterIuivEXT, (GLenum, GLenum, GLenum, GLuint *))
AGL_API(void, glProgramUniform1fEXT, (GLuint, GLint, GLfloat))
AGL_API(void, glProgramUniform2fEXT, (GLuint, GLint, GLfloat, GLfloat))
AGL_API(void, glProgramUniform3fEXT, (GLuint, GLint, GLfloat, GLfloat, GLfloat))
AGL_API(void, glProgramUniform4fEXT, (GLuint, GLint, GLfloat, GLfloat, GLfloat, GLfloat))
AGL_API(void, glProgramUniform1iEXT, (GLuint, GLint, GLint))
AGL_API(void, glProgramUniform2iEXT, (GLuint, GLint, GLint, GLint))
AGL_API(void, glProgramUniform3iEXT, (GLuint, GLint, GLint, GLint, GLint))
AGL_API(void, glProgramUniform4iEXT, (GLuint, GLint, GLint, GLint, GLint, GLint))
AGL_API(void, glProgramUniform1fvEXT, (GLuint, GLint, GLsizei, const GLfloat *))
AGL_API(void, glProgramUniform2fvEXT, (GLuint, GLint, GLsizei, const GLfloat *))
AGL_API(void, glProgramUniform3fvEXT, (GLuint, GLint, GLsizei, const GLfloat *))
AGL_API(void, glProgramUniform4fvEXT, (GLuint, GLint, GLsizei, const GLfloat *))
AGL_API(void, glProgramUniform1ivEXT, (GLuint, GLint, GLsizei, const GLint *))
AGL_API(void, glProgramUniform2ivEXT, (GLuint, GLint, GLsizei, const GLint *))
AGL_API(void, glProgramUniform3ivEXT, (GLuint, GLint, GLsizei, const GLint *))
AGL_API(void, glProgramUniform4ivEXT, (GLuint, GLint, GLsizei, const GLint *))
AGL_API(void, glProgramUniformMatrix2fvEXT, (GLuint, GLint, GLsizei, GLboolean, const GLfloat *))
AGL_API(void, glProgramUniformMatrix3fvEXT, (GLuint, GLint, GLsizei, GLboolean, const GLfloat *))
AGL_API(void, glProgramUniformMatrix4fvEXT, (GLuint, GLint, GLsizei, GLboolean, const GLfloat *))
AGL_API(void, glProgramUniformMatrix2x3fvEXT, (GLuint, GLint, GLsizei, GLboolean, const GLfloat *))
AGL_API(void, glProgramUniformMatrix3x2fvEXT, (GLuint, GLint, GLsizei, GLboolean, const GLfloat *))
AGL_API(void, glProgramUniformMatrix2x4fvEXT, (GLuint, GLint, GLsizei, GLboolean, const GLfloat *))
AGL_API(void, glProgramUniformMatrix4x2fvEXT, (GLuint, GLint, GLsizei, GLboolean, const GLfloat *))
AGL_API(void, glProgramUniformMatrix3x4fvEXT, (GLuint, GLint, GLsizei, GLboolean, const GLfloat *))
AGL_API(void, glProgramUniformMatrix4x3fvEXT, (GLuint, GLint, GLsizei, GLboolean, const GLfloat *))
AGL_API(void, glProgramUniform1uiEXT, (GLuint, GLint, GLuint))
AGL_API(void, glProgramUniform2uiEXT, (GLuint, GLint, GLuint, GLuint))
AGL_API(void, glProgramUniform3uiEXT, (GLuint, GLint, GLuint, GLuint, GLuint))
AGL_API(void, glProgramUniform4uiEXT, (GLuint, GLint, GLuint, GLuint, GLuint, GLuint))
AGL_API(void, glProgramUniform1uivEXT, (GLuint, GLint, GLsizei, const GLuint *))
AGL_API(void, glProgramUniform2uivEXT, (GLuint, GLint, GLsizei, const GLuint *))
AGL_API(void, glProgramUniform3uivEXT, (GLuint, GLint, GLsizei, const GLuint *))
AGL_API(void, glProgramUniform4uivEXT, (GLuint, GLint, GLsizei, const GLuint *))
AGL_API(void, glNamedBufferDataEXT, (GLuint, GLsizeiptr, const GLvoid *, GLenum))
AGL_API(void, glNamedBufferSubDataEXT, (GLuint, GLintptr, GLsizeiptr, const GLvoid *))
AGL_API(GLvoid*, glMapNamedBufferEXT, (GLuint, GLenum))
AGL_API(GLboolean, glUnmapNamedBufferEXT, (GLuint))
AGL_API(void, glGetNamedBufferParameterivEXT, (GLuint, GLenum, GLint *))
AGL_API(void, glGetNamedBufferPointervEXT, (GLuint, GLenum, GLvoid* *))
AGL_API(void, glGetNamedBufferSubDataEXT, (GLuint, GLintptr, GLsizeiptr, GLvoid *))
AGL_API(void, glTextureBufferEXT, (GLuint, GLenum, GLenum, GLuint))
AGL_API(void, glMultiTexBufferEXT, (GLenum, GLenum, GLenum, GLuint))
AGL_API(void, glNamedRenderbufferStorageEXT, (GLuint, GLenum, GLsizei, GLsizei))
AGL_API(void, glGetNamedRenderbufferParameterivEXT, (GLuint, GLenum, GLint *))
AGL_API(GLenum, glCheckNamedFramebufferStatusEXT, (GLuint, GLenum))
AGL_API(void, glNamedFramebufferTexture1DEXT, (GLuint, GLenum, GLenum, GLuint, GLint))
AGL_API(void, glNamedFramebufferTexture2DEXT, (GLuint, GLenum, GLenum, GLuint, GLint))
AGL_API(void, glNamedFramebufferTexture3DEXT, (GLuint, GLenum, GLenum, GLuint, GLint, GLint))
AGL_API(void, glNamedFramebufferRenderbufferEXT, (GLuint, GLenum, GLenum, GLuint))
AGL_API(void, glGetNamedFramebufferAttachmentParameterivEXT, (GLuint, GLenum, GLenum, GLint *))
AGL_API(void, glGenerateTextureMipmapEXT, (GLuint, GLenum))
AGL_API(void, glGenerateMultiTexMipmapEXT, (GLenum, GLenum))
AGL_API(void, glFramebufferDrawBufferEXT, (GLuint, GLenum))
AGL_API(void, glFramebufferDrawBuffersEXT, (GLuint, GLsizei, const GLenum *))
AGL_API(void, glFramebufferReadBufferEXT, (GLuint, GLenum))
AGL_API(void, glGetFramebufferParameterivEXT, (GLuint, GLenum, GLint *))
AGL_API(void, glNamedRenderbufferStorageMultisampleEXT, (GLuint, GLsizei, GLenum, GLsizei, GLsizei))
AGL_API(void, glNamedRenderbufferStorageMultisampleCoverageEXT, (GLuint, GLsizei, GLsizei, GLenum, GLsizei, GLsizei))
AGL_API(void, glNamedFramebufferTextureEXT, (GLuint, GLenum, GLuint, GLint))
AGL_API(void, glNamedFramebufferTextureLayerEXT, (GLuint, GLenum, GLuint, GLint, GLint))
AGL_API(void, glNamedFramebufferTextureFaceEXT, (GLuint, GLenum, GLuint, GLint, GLenum))
AGL_API(void, glTextureRenderbufferEXT, (GLuint, GLenum, GLuint))
AGL_API(void, glMultiTexRenderbufferEXT, (GLenum, GLenum, GLuint))
#endif
