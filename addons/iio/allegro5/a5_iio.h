...
A5_IIO_FUNC(bool, iio_init, (void));
A5_IIO_FUNC(bool, iio_add_loader, (AL_CONST char *ext, IIO_LOADER_FUNCTION function));
A5_IIO_FUNC(ALLEGRO_BITMAP *, iio_load, (AL_CONST char *filename));
